...
const CheckoutPage = () => {
  ...
  // Calculate shipping
  const shipping = subtotal >= 300 ? 0 : 25.90;
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center py-16">
            <h1 className="text-2xl font-bold text-shark-900 mb-4">Seu carrinho está vazio</h1>
            <p className="text-shark-600 mb-6">Adicione produtos ao carrinho antes de finalizar a compra.</p>
            <Button asChild>
              <Link to="/products">
        ...
        <main className="flex-1 py-12">
          <div className="container mx-auto px-4 max-w-3xl">
            <div className="bg-white p-8 rounded-lg shadow border border-shark-200 text-center">
              ...
              <h1 className="text-2xl font-bold text-shark-900 mb-2">Pedido realizado com sucesso!</h1>
              ...
              <div className="border rounded-md p-4 mb-6 text-left bg-shark-50">
                ...
                <p><span className="font-medium">Número do pedido:</span> #PF{Math.floor(Math.random() * 10000)}</p>
                <p><span className="font-medium">Total:</span> R$ {total.toFixed(2).replace('.', ',')}</p>
                <p><span className="font-medium">Endereço de entrega:</span> {formData.address}, {formData.city}, {formData.state}</p>
              </div>
              
              <p className="text-sm text-shark-600 mb-6">
                Um email com os detalhes da compra foi enviado para {formData.email}
              </p>
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 py-12 bg-[#0A0D0D] text-black-100">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold text-black-50 mb-8 text-center">Finalizar Compra</h1>
            ...
            <div className="lg:w-2/3">
              <div className="bg-black-900 rounded-lg shadow border border-black-700 overflow-hidden">
                <div className="flex border-b border-black-700">
                  <div className={`flex-1 p-4 text-center ${step === 1 ? 'bg-black-700 text-black-50 font-medium' : 'text-black-300'}`}>
                    1. Informações de Entrega
                  </div>
                  <div className={`flex-1 p-4 text-center ${step === 2 ? 'bg-black-700 text-black-50 font-medium' : 'text-black-300'}`}>
                    2. Pagamento
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6">
                  {step === 1 && (
                    <div className="space-y-6">
                      <h2 className="text-2xl font-bold text-black-50">Informações Pessoais e Entrega</h2>
                      
                      <div className="space-y-3">
                        <div>
                          <Label htmlFor="fullName" className="text-black-100">Nome Completo</Label>
                          <Input
                            id="fullName"
                            name="fullName"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <Label htmlFor="email" className="text-black-100">Email</Label>
                            <Input
                              id="email"
                              name="email"
                              type="email"
                          ...
                          <div>
                            <Label htmlFor="phone" className="text-black-100">Telefone</Label>
                            <Input
                              id="phone"
                              name="phone"
                              type="tel"
                      ...
                      <div className="space-y-3">
                        <h3 className="text-xl font-bold text-black-50 mt-6">Endereço de Entrega</h3>
                        
                        <div>
                          <Label htmlFor="address" className="text-black-100">Endereço Completo</Label>
                          <Input
                            id="address"
                            name="address"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div>
                            <Label htmlFor="city" className="text-black-100">Cidade</Label>
                            <Input
                              id="city"
                              name="city"
                              value={formData.city}
                          ...
                          <div>
                            <Label htmlFor="state" className="text-black-100">Estado</Label>
                          ...
                          <div>
                            <Label htmlFor="zipCode" className="text-black-100">CEP</Label>
                            <Input
                              id="zipCode"
                              name="zipCode"
                  ...
                  {step === 2 && (
                    <div className="space-y-6">
                      <h2 className="text-2xl font-bold text-black-50">Detalhes do Pagamento</h2>
                      ...
                      <div className="bg-shark-50 p-4 rounded-md border border-shark-200 mb-6">
                        <div className="flex items-center mb-2">
                          ...
                          <h3 className="font-medium text-shark-800">Cartão de Crédito</h3>
                        </div>
                        
                        <div className="space-y-3">
                          <div>
                            <Label htmlFor="cardNumber" className="text-black-100">Número do Cartão</Label>
                            <Input
                              id="cardNumber"
                              name="cardNumber"
                          ...
                          <div>
                            <Label htmlFor="cardName" className="text-black-100">Nome no Cartão</Label>
                            <Input
                              id="cardName"
                              name="cardName"
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              <Label htmlFor="expiry" className="text-black-100">Data de Expiração (MM/AA)</Label>
                              <Input
                                id="expiry"
                                name="expiry"
                            ...
                            <div>
                              <Label htmlFor="cvv" className="text-black-100">CVV</Label>
                              <Input
                                id="cvv"
                                name="cvv"
                                value={formData.cvv}
            ...
            <div className="lg:w-1/3">
              ...
              <div className="bg-black-900 rounded-lg shadow border border-black-700 p-6 mb-6">
                ...
                <div className="flex gap-2 mb-4">
                  ...
                  />
                  <Button variant="outline" className="border-black-700 hover:bg-black-700 text-black-100">Aplicar</Button>
                </div>
                <div className="flex items-center text-sm text-black-300">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5 mr-2 text-yellow-500">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />
                  </svg>
                  Para poderes aplicar os cupões, o teu carrinho deve cumprir com os requisitos da loja.
                </div>
              </div>
              {/* End Coupon Section */}
              <div className="bg-black-900 rounded-lg shadow border border-black-700 p-6 sticky top-24">
                <h2 className="text-2xl font-bold text-black-50 mb-4">Resumo do Pedido</h2>
                  ...
                  {items.map((item) => (
                    <div key={item.product.id} className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-black-50 line-clamp-1">{item.product.name}</p>
                        <div className="flex items-baseline gap-1 text-sm">
                          <span className="text-white">Qtd: {item.quantity}</span>
                          <span>·</span>
                ...
                <div className="space-y-2 text-sm border-t border-black-700 pt-4">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-black-50">R$ {subtotal.toFixed(2).replace('.', ',')}</span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    {shipping === 0 ? (
                      ...
                      <span className="font-medium text-black-50">R$ {shipping.toFixed(2).replace('.', ',')}</span>
                    )}
                  </div>
                  {shipping === 0 && (
                ...
                <div className="flex justify-between border-t border-black-700 pt-4 mt-4">
                  ...
                  <span className="font-bold text-xl text-black-50">R$ {total.toFixed(2).replace('.', ',')}</span>
                </div>
