...
const EnvioEntregaPage = () => {
  return (
    <div className="page-container min-h-screen flex flex-col">
      <Helmet>
        <title>TurboGainz - Envio e Entrega</title>
        {/* Favicons */}
        <link
          rel="icon"
        ...
        <section className="py-16 text-black-100">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <p className="text-black-300 mb-4">
              Saiba como funciona o processo de envio e entrega dos nossos
              produtos.
            </p>
            <ul className="list-disc pl-6 text-black-300 space-y-2">
              <li>
                Prazo de postagem: até 2 dias úteis após a confirmação do
                pagamento.
              </li>
              <li>
                Prazo de entrega: varia conforme a região e modalidade
                escolhida.
              </li>
              <li>
                Rastreamento: você receberá um código para acompanhar seu
                pedido.
              </li>
